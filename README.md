...
Want to add your own custom app to this repo? Follow the instructions below<a href="https://github.com/3raxton/spicetify-custom-apps/CONTRIBUTING.MD"  target="_blank"> or read the CONTRIBUTING.MD file</a>
